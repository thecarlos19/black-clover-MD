...
const msg = {
    rowner: '[ ✞ ] 𝒆𝒍 𝒄𝒐𝒎𝒂𝒏𝒅𝒐 𝒆𝒔 𝒆𝒙𝒄𝒍𝒖𝒔𝒊𝒗𝒐 𝒑𝒂𝒓𝒂 𝒐𝒘𝒏𝒆𝒓𝒔.',
    owner: '[ ✞ ] 𝒆𝒍 𝒄𝒐𝒎𝒂𝒏𝒅𝒐 𝒆𝒔 𝒆𝒙𝒄𝒍𝒖𝒔𝒊𝒗𝒐 𝒑𝒂𝒓𝒂 𝒐𝒘𝒏𝒆𝒓𝒔.',
    mods: '[ ✞ ] 𝒆𝒍 𝒄𝒐𝒎𝒂𝒏𝒅𝒐 𝒔𝒐𝒍𝒐 𝒍𝒐 𝒑𝒖𝒆𝒅𝒆𝒏 𝒖𝒔𝒂𝒓 𝒍𝒐𝒔 𝒎𝒐𝒅𝒆𝒓𝒂𝒅𝒐𝒓𝒆𝒔.',
    premium: '[ ✞ ] 𝒆𝒔𝒕𝒆 𝒄𝒐𝒎𝒂𝒏𝒅𝒐 𝒆𝒔 𝒔𝒐𝒍𝒐 𝒑𝒂𝒓𝒂 𝒖𝒔𝒖𝒂𝒓𝒊𝒐𝒔 𝒑𝒓𝒆𝒎𝒊𝒖𝒎.',
    group: '[ ✞ ] 𝒆𝒔𝒕𝒆 𝒄𝒐𝒎𝒂𝒏𝒅𝒐 𝒔𝒐𝒍𝒐 𝒔𝒆 𝒑𝒖𝒆𝒅𝒆 𝒖𝒔𝒂𝒓 𝒆𝒏 𝒈𝒓𝒖𝒑𝒐𝒔.',
    private: '[ ✞ ] 𝒆𝒔𝒕𝒆 𝒄𝒐𝒎𝒂𝒏𝒅𝒐 𝒔𝒐𝒍𝒐 𝒔𝒆 𝒑𝒖𝒆𝒅𝒆 𝒖𝒔𝒂𝒓 𝒆𝒏 𝒄𝒉𝒂𝒕 𝒑𝒓𝒊𝒗𝒂𝒅𝒐.',
    admin: '[ ✞ ] 𝒆𝒔𝒕𝒆 𝒄𝒐𝒎𝒂𝒏𝒅𝒐 𝒔𝒐𝒍𝒐 𝒍𝒐 𝒑𝒖𝒆𝒅𝒆𝒏 𝒖𝒔𝒂𝒓 𝒍𝒐𝒔 𝒂𝒅𝒎𝒊𝒏𝒔 𝒅𝒆𝒍 𝒈𝒓𝒖𝒑𝒐.',
    botAdmin: '[ ✞ ] 𝒑𝒂𝒓𝒂 𝒖𝒔𝒂𝒓 𝒆𝒔𝒕𝒆 𝒄𝒐𝒎𝒂𝒏𝒅𝒐 𝒆𝒔 𝒏𝒆𝒄𝒆𝒔𝒂𝒓𝒊𝒐 𝒒𝒖𝒆 𝒚𝒐 𝒔𝒆𝒂 𝒂𝒅𝒎𝒊𝒏.',
    unreg: '[ ✞ ] ¡𝑯𝒆𝒚! 𝒏𝒐 𝒆𝒔𝒕𝒂𝒔 𝒓𝒆𝒈𝒊𝒔𝒕𝒓𝒂𝒅𝒐, 𝒓𝒆𝒈𝒊𝒔𝒕𝒓𝒆𝒔𝒆 𝒑𝒂𝒓𝒂 𝒖𝒔𝒂𝒓 𝒆𝒔𝒕𝒂 𝒇𝒖𝒏𝒄𝒊𝒐́𝒏\n\n#𝒓𝒆𝒈 𝒏𝒐𝒎𝒃𝒓𝒆.𝒆𝒅𝒂𝒅\n\n_𝑨𝒒𝒖𝒊́ 𝒖𝒏 𝑬𝒋𝒆𝒎𝒑𝒍𝒐_ = #𝒓𝒆𝒈 Montana.22',
    restrict: '[ ✞ ] 𝐄𝐬𝐭𝐚 𝐜𝐚𝐫𝐚𝐜𝐭𝐞𝐫𝐢́𝐬𝐭𝐢𝐜𝐚 𝐞𝐬𝐭𝐚 𝐝𝐞𝐬𝐚𝐜𝐭𝐢𝐯𝐚𝐝𝐚.'
}[type];
